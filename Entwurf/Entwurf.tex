...
%TODO Bild einfügen
\textbf{Beschreibung:} Implementierung der \textbf{IEntity} Schnittstelle, als Vorlage für eine SQLite-Datenbanktabelle.\\
Weiterhin wird die \textbf{IEntityObservable} Schnittstelle implementiert, sodass die Datenbank über Änderungen informiert werden kann.

\textbf{Attribute:}\\
+ \textit{id : int} - Die ID über die Entitäten in der Datenbank identifiziert werden können\\
