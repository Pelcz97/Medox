...
\textbf{Entwurfsentscheidung:} %TODO
...
\textbf{Enthaltene Klassen:} IEntityObservable, IEntityObserver, IProfileObserver
...
\subsubsection{EntityDatabase : IEntityDatabase, IProfileObserver}
%TODO Bild einfügen
...
+ \textit{observer : IEntityObserver} - Der Beobachter der Entität
...
+ \textit{observer : IProfileObserver} - Der Beobachter des Profils
...
\subsubsection{IProfileObserver : IEntityObserver}
%TODO Bild einfügen
\textbf{Beschreibung:} Die Schnittstelle \textbf{IProfileObserver} erweitert die\textbf{IIEntityObserver} Schnittstelle.\\
Zusätzlich zu Änderungen und Löschung können über diese Schnittstelle angemeldete Beobachter über die Aktivierung eines Objekts benachrichtigt werden.
