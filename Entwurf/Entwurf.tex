...
Weiterhin werden die \textbf{IEntityObserver} und \textbf{IProfileObserver} Schnittstellen implementiert, sodass sich die Datenbank über Änderungen an den in ihr gespeicherten Entitäten informieren lassen kann.

\textbf{Attribute:}\\
+ \textit{profile : Profile} - Das zurzeit aktive Profil
