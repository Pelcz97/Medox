...
\vspace*{2.5mm}\\
\textbf{Enthaltene Klassen:} IModelFacade, ModelFacade
...
%TODO
\textbf{Funktion:} Dieses Paket enthält die Implementierung der verschiedenen Datentypen, die in DataModelInterface beschrieben werden
\vspace*{2.5mm}\\
