...
\end{minipage}
\end{figure}
%TODO kurzen Text schreiben. (Wieso haben wir unseren Ablauf geändert)
\section{Zukunftspläne}
%TODO Redesign der App: Ein Tab für Arztbriefe, Medikationen und Impfungen (alle möglichen Information) um Informationsdichte zu erhöhen. Dazu kommt dann eine Sortier/Suchfunktion. Implementierung der nicht umgesetzten Kriterien.
