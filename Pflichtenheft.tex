...
Ereignisfluss: Nutzer startet App $\Rightarrow$ Neues Profil erstellen $\Rightarrow$ Nutzer-Informationen eingeben $\Rightarrow$  Medikamente hinzufügen\\
...
\subsection{Einstellungen}
\begin{tabular}{lll}
[BT3010] & \multicolumn{2}{p{12cm}}  {Ein Nutzerprofil wird angelegt.} \\
{[BT3020]} & \multicolumn{2}{p{12cm}}  {Ein Nutzerprofil wird bearbeitet.} \\
\end{tabular}
...
{[BT4070]} & \multicolumn{2}{p{12cm}}  {Nutzerhandy wird als Empfänger gewählt.} \\
...
{[ET1020]} & \multicolumn{2}{p{12cm}}  {myMD \gls{App} sendet mehrere Datei an die \gls{Desktop Anwendung}.} \\
...
{[ET3030]} & \multicolumn{2}{p{12cm}}  {Wechsel zwischen mehreren Nutzerprofilen.} \\
{[ET3040]} & \multicolumn{2}{p{12cm}}  {Einzelnen Arztbrief als sensibel markieren.} \\
{[ET3050]} & \multicolumn{2}{p{12cm}}  {Sensibel Markierung eines einzelnen Arztbriefes aufheben.} \\
{[ET3060]} & \multicolumn{2}{p{12cm}}  {Gruppe von Arztbriefen als sensibel markieren.} \\
{[ET3070]} & \multicolumn{2}{p{12cm}}  {Sensibel Markierung einer Gruppe von Arztbriefen aufheben.} \\
{[ET3080]} & \multicolumn{2}{p{12cm}}  {Regelmäßiger Arzttermin wird hinzugefügt.} \\
{[ET3090]} & \multicolumn{2}{p{12cm}}  {Regelmäßiger Arzttermin wird gelöscht.} \\
...
\begin{tabular}{lll}
[BT4060] & \multicolumn{2}{p{12cm}}  {Geräte in der Nähe werden gesucht.} \\
{[BT4070]} & \multicolumn{2}{p{12cm}}  {Das Handy des Nutzers wird als Empfänger ausgewählt.} \\
{[BT4030]} & \multicolumn{2}{p{12cm}}  {Senden wird erfolgreich abgeschlossen.} \\
...
Der Nutzer ist daheim und schaut sich in der myMD \gls{App} seine Übersicht an. Er klickt auf ein paar Arztbriefe und liest sich durch, was darin steht. Dann bemerkt er, dass er alle Arztbriefe zu seinem gebrochenen Fuß gruppieren sollte und auch die Schmerzmittel, die für seinen Fuß bekommen hat, in den Tab Medikamente hinzufügen. Aus versehen gibt er zuerst eine falsche Menge an, korrigiert diese aber und schließt daraufhin die App.\newline
...
\subsection{Patienten holt sich bei einem anderen Arzt eine zweite Meinung ein}
