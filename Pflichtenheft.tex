...
{[MK1020]} & \multicolumn{2}{p{12cm}}  {Der Patient kann mehrere Arztbriefe gleichzeitig senden.} \\
{[MK1030]} & \multicolumn{2}{p{12cm}}  {\gls{NFC} steht als weitere Übertragunsmöglichkeit zur Verfügung.} \\
...
\subsection{Patientenseitige Datenübertragung}
\begin{tabular}{lll}
[GF1010]&  \multicolumn{2}{p{12cm}}{Empfangen von Arztbriefen [PK1010].}\\
...
{[GF4050]} &  \multicolumn{2}{p{12cm}}{Hinzufügen eines Profilbildes zum Nutzerprofil [PK3010].}  \\
\end{tabular}
