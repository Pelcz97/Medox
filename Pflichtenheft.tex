...
{Ereignisfluss} & \multicolumn{2}{p{11.5cm}} {Verbindung zwischen Arzt und Patienten wird hergestellt --> Arzt fügt zu übertragende Daten in die Anwendung ein --> Die Daten werden vom Arzt zum Patienten übertragen --> Verbindung zwischen Arzt und Patient wird getrennt --> Patient kann Daten einsehen} \\
...
{Ereignisfluss} & \multicolumn{2}{p{11.5cm}} {Nutzer startet App --> Neues Profil erstellen --> Nutzer-Informationen eingeben -->  Medikamente hinzufügen} \\
