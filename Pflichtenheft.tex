...
\begin{tabular}{lll}
[PK2010] & \multicolumn{2}{p{12cm}}  {Arztbriefe werden chronologisch absteigend im \gls{Tab} Übersicht dargestellt.} \\
...
{[WK3040]} & \multicolumn{2}{p{12cm}}  {Die myMD \gls{App} ermöglicht, den Nutzer zu regelmäßigen Arztterminen (z.B. Zahnarzt, Augenarzt) zu erinnern.} \\
...
{Über die Tab-Bar am unteren Bildschirmrand sind weitere Funktionen der App erreichbar}
...
\textbf{Verwendung}\\
In dieser Ansicht können Diagnose und Behandlung eines Arztbesuches näher studiert werden. Dazu kann durch vertikales Wischen durch die Texte gescrollt werden
\end{minipage}%
...
{Textfeld: Einnahmedauer eines Medikaments}\\
{Textfeld: Einnahmehäufigkeit eines Medikaments}\\
{Textbox: Datum der erstmaligen Einnahme}\\
{Textbox: Dosierung des Wirkstoffes}\\
{Button: Hinzufügen eines Medikamentes}\\
{Tab Bar: Navigieren durch die App}

\textbf{Verwendung}\\
Durch vertikales Wischen kann durch die Auflistung aller Arztbriefe navigiert werden; Horzontales Wischen vom rechten Rand eines Listenelements nach links löscht den Eintrag
...
\textbf{Elemente}\\
Pop-Up Fenster mit Name des anfragenden Arztes
Button zum Ablehnen der Anfrage
Button zum Zustimmen der Anfrage
...
{TODO}\\
\textbf{Elemente}\\
Textbox mit den Sendevorgang betreffenden Nutzerhinweisen
Button zum Starten des Auswahlvorgangs von Arztbriefen

\textbf{Verwendung}\\
ISollte sich der Nutzer entschließen, Arztbriefe an einen Arzt zu übermitteln, öffnet der große Knopf in der unteren Bildschirmhälfte in eine Liste aller Arztbriefe auf dem Gerät, aus denen der Nutzer dann diejenigen auswählen, die er gerne versenden würde.
\end{minipage}%
...
{[ET1030]} & \multicolumn{2}{p{12cm}}  {\gls{Desktop Anwendung} sendet mehrere Dateien an die myMD \gls{App}.} \\
...
Der Nutzer geht wegen einer Erkrankung zum Arzt und lässt sich untersuchen. Sobald die Untersuchung fertig ist, verlangt der Nutzer, dass der Arzt ihm die eben erhobenen Daten für die myMD \gls{App} zur Verfügung stellt. Der Arzt öffnet dann die \gls{Desktop Anwendung} und schickt dem Patienten den Arztbrief und Labordaten auf die myMD \gls{App}. Der Nutzer schaut sich dann kurz den neuen Eintrag in der Übersicht an, schließt die App und geht nach Hause. \newline
