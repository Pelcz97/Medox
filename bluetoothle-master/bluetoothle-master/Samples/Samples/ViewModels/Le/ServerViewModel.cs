...
namespace Samples.ViewModels.Le
{
    public class ServerViewModel : AbstractRootViewModel
    {
        ...
        {
            //BleAdapter.WhenStatusChanged().Subscribe(status => { Debug.WriteLine("CrossBLEAdapterstatus : " + status); });
            ...
            this.BleAdapter
                ...
                {
                    this.Status = x;
                    Debug.WriteLine("Status changed to:" + BleAdapter.Status);
                });
            ...
            this.ToggleServer = ReactiveCommand.CreateFromTask(async _ =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    Debug.WriteLine("Excpetion Server state:" + server.IsRunning);
                }
            });
